...
<?php 
	// Can't add a new page unless we have a subject a parent!
	if (!$current_subject) {
...
<?php 
	if (isset($_POST['submit'])) {
		...
		if (empty($errors)) {
			...
			$content = mysql_prep($_POST["content"]); // mysql_prep() is used to escape strings
