...
<!-- form -->
<?php $layout_context = "admin"; ?> <!-- we set the context BEFORE we include the file below -->
            ...
            <div id="page">
                ...
                <form action="edit_page.php?page=<?php echo urlencode($current_page['id']); ?>" method="post">
                    ...
                    <p>Position:
                        ...
                        <?php
                            //$subject_count = 8;
                            $page_set = find_pages_for_subject($current_page["subject_id"], false); // SECRET TECHNIQUE: returns all pages to us
